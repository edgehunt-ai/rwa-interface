...
// tests for RealtimeResyncRequiredEvent
void main() {
  final instance = RealtimeResyncRequiredEventBuilder();
  // TODO add properties to the builder and call build()

  group(RealtimeResyncRequiredEvent, () {
    ...
    // RealtimeResyncRequiredEventAllOfData data
