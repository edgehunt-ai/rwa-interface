...
// tests for Transfer
void main() {
  final instance = TransferBuilder();
  // TODO add properties to the builder and call build()

  group(Transfer, () {
    // String transferId
    test('to test the property `transferId`', () async {
      // TODO
    });
    ...
    // AccountKind fromAccount
    test('to test the property `fromAccount`', () async {
      // TODO
    });

    // AccountKind toAccount
    test('to test the property `toAccount`', () async {
      // TODO
    });
