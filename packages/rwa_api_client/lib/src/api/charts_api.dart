...
class ChartsApi {
  ...
  Future<Response<CandleSeries>> getCandles({
    ...
    final _path = r'/v1/markets/{symbol}/products/{kind}/candles'
        .replaceAll(
            '{' r'symbol' '}',
    ...
    final _queryParameters = <String, dynamic>{
      if (range != null)
        r'range': encodeQueryParameter(
            _serializers, range, const FullType(ChartRange)),
      if (from != null)
        r'from':
      ...
      if (interval != null)
        r'interval': encodeQueryParameter(
            _serializers, interval, const FullType(String)),
    };
  ...
  Future<Response<ReferencePrice>> getReferencePrice({
    ...
    final _path = r'/v1/markets/{symbol}/reference-price'.replaceAll(
        '{' r'symbol' '}',
        encodeQueryParameter(_serializers, symbol, const FullType(String))
            .toString());
    final _options = Options(
