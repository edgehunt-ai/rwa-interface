...
class MarketsApi {
  ...
  /// 产品详情
  /// 详情页顶部报价、产品说明、资产权益与行情统计的聚合接口。bStock 详情还返回无需填写数量即可展示的买入/卖出输入资产；实际交易仍须重新预览。
  ///
  /// Parameters:
  /// * [symbol] - 股票代码
  /// * [kind] 
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [BstocksSupportedTokenPage] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BstocksSupportedTokenPage>> listBstocksSupportedTokens({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/v1/markets/bstocks/supported';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    BstocksSupportedTokenPage? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(BstocksSupportedTokenPage),
      ) as BstocksSupportedTokenPage;
    ...
    return Response<BstocksSupportedTokenPage>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<ProductPage>> listProducts({ 
    ...
    final _path = r'/v1/markets/products';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<StockPage>> listStocks({ 
    ...
    final _path = r'/v1/markets/stocks';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<void>> replaceFavorites({ 
    ...
    final _path = r'/v1/markets/favorites';
    final _options = Options(
      method: r'PUT',
      headers: <String, dynamic>{
        ...?headers,
