...
/// * [provenance] 
@BuiltValue()
abstract class PerpFundingTargetAsset implements Built<PerpFundingTargetAsset, PerpFundingTargetAssetBuilder> {
  ...
  factory PerpFundingTargetAsset([void updates(PerpFundingTargetAssetBuilder b)]) = _$PerpFundingTargetAsset;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(PerpFundingTargetAssetBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<PerpFundingTargetAsset> get serializer => _$PerpFundingTargetAssetSerializer();
}

class _$PerpFundingTargetAssetSerializer implements PrimitiveSerializer<PerpFundingTargetAsset> {
  @override
  final Iterable<Type> types = const [PerpFundingTargetAsset, _$PerpFundingTargetAsset];
...
class PerpFundingTargetAssetAssetIdEnum extends EnumClass {
  ...
  static BuiltSet<PerpFundingTargetAssetAssetIdEnum> get values => _$perpFundingTargetAssetAssetIdEnumValues;
  static PerpFundingTargetAssetAssetIdEnum valueOf(String name) => _$perpFundingTargetAssetAssetIdEnumValueOf(name);
}
...
class PerpFundingTargetAssetNamespaceEnum extends EnumClass {
  ...
  static BuiltSet<PerpFundingTargetAssetNamespaceEnum> get values => _$perpFundingTargetAssetNamespaceEnumValues;
  static PerpFundingTargetAssetNamespaceEnum valueOf(String name) => _$perpFundingTargetAssetNamespaceEnumValueOf(name);
}
...
class PerpFundingTargetAssetNetworkEnum extends EnumClass {
  ...
  static BuiltSet<PerpFundingTargetAssetNetworkEnum> get values => _$perpFundingTargetAssetNetworkEnumValues;
  static PerpFundingTargetAssetNetworkEnum valueOf(String name) => _$perpFundingTargetAssetNetworkEnumValueOf(name);
}
...
class PerpFundingTargetAssetChainIdEnum extends EnumClass {
  ...
  static BuiltSet<PerpFundingTargetAssetChainIdEnum> get values => _$perpFundingTargetAssetChainIdEnumValues;
  static PerpFundingTargetAssetChainIdEnum valueOf(String name) => _$perpFundingTargetAssetChainIdEnumValueOf(name);
}
...
class PerpFundingTargetAssetTokenEnum extends EnumClass {
  ...
  static BuiltSet<PerpFundingTargetAssetTokenEnum> get values => _$perpFundingTargetAssetTokenEnumValues;
  static PerpFundingTargetAssetTokenEnum valueOf(String name) => _$perpFundingTargetAssetTokenEnumValueOf(name);
}
...
class PerpFundingTargetAssetTokenContractEnum extends EnumClass {
  ...
  static BuiltSet<PerpFundingTargetAssetTokenContractEnum> get values => _$perpFundingTargetAssetTokenContractEnumValues;
  static PerpFundingTargetAssetTokenContractEnum valueOf(String name) => _$perpFundingTargetAssetTokenContractEnumValueOf(name);
}
...
class PerpFundingTargetAssetTokenDecimalsEnum extends EnumClass {
  ...
  static BuiltSet<PerpFundingTargetAssetTokenDecimalsEnum> get values => _$perpFundingTargetAssetTokenDecimalsEnumValues;
  static PerpFundingTargetAssetTokenDecimalsEnum valueOf(String name) => _$perpFundingTargetAssetTokenDecimalsEnumValueOf(name);
}
...
class PerpFundingTargetAssetProvenanceEnum extends EnumClass {
  ...
  static BuiltSet<PerpFundingTargetAssetProvenanceEnum> get values => _$perpFundingTargetAssetProvenanceEnumValues;
  static PerpFundingTargetAssetProvenanceEnum valueOf(String name) => _$perpFundingTargetAssetProvenanceEnumValueOf(name);
}
