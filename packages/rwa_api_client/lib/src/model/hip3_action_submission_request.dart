...
/// * [signature]
@BuiltValue()
abstract class Hip3ActionSubmissionRequest
    implements
        Built<Hip3ActionSubmissionRequest, Hip3ActionSubmissionRequestBuilder> {
  @BuiltValueField(wireName: r'signature')
  HyperliquidSignature get signature;

  Hip3ActionSubmissionRequest._();

  factory Hip3ActionSubmissionRequest(
          [void updates(Hip3ActionSubmissionRequestBuilder b)]) =
      _$Hip3ActionSubmissionRequest;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(Hip3ActionSubmissionRequestBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<Hip3ActionSubmissionRequest> get serializer =>
      _$Hip3ActionSubmissionRequestSerializer();
}

class _$Hip3ActionSubmissionRequestSerializer
    implements PrimitiveSerializer<Hip3ActionSubmissionRequest> {
  @override
