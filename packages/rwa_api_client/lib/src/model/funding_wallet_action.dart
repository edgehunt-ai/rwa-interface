...
/// * [refundAddress]
@BuiltValue()
abstract class FundingWalletAction
    implements Built<FundingWalletAction, FundingWalletActionBuilder> {
  ...
  factory FundingWalletAction([void updates(FundingWalletActionBuilder b)]) =
      _$FundingWalletAction;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(FundingWalletActionBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<FundingWalletAction> get serializer =>
      _$FundingWalletActionSerializer();
}
...
extension FundingWalletActionBuilderDiscriminatorExt
    on FundingWalletActionBuilder {
  String? get discriminatorValue {
...
class _$FundingWalletActionSerializer
    implements PrimitiveSerializer<FundingWalletAction> {
  @override
  ...
  FundingWalletAction deserialize(
    ...
    final discIndex =
        serializedList.indexOf(FundingWalletAction.discriminatorFieldName) + 1;
...
class FundingWalletActionKindEnum extends EnumClass {
  ...
  static const FundingWalletActionKindEnum originTransaction =
      _$fundingWalletActionKindEnum_originTransaction;
  @BuiltValueEnumConst(wireName: r'unknown_default_open_api', fallback: true)
  static const FundingWalletActionKindEnum unknownDefaultOpenApi =
      _$fundingWalletActionKindEnum_unknownDefaultOpenApi;

  static Serializer<FundingWalletActionKindEnum> get serializer =>
      _$fundingWalletActionKindEnumSerializer;

  const FundingWalletActionKindEnum._(String name) : super(name);

  static BuiltSet<FundingWalletActionKindEnum> get values =>
      _$fundingWalletActionKindEnumValues;
  static FundingWalletActionKindEnum valueOf(String name) =>
      _$fundingWalletActionKindEnumValueOf(name);
}

class FundingWalletActionChainIdEnum extends EnumClass {
  @BuiltValueEnumConst(wireNumber: 1)
  static const FundingWalletActionChainIdEnum number1 =
      _$fundingWalletActionChainIdEnum_number1;
  @BuiltValueEnumConst(wireNumber: 56)
  static const FundingWalletActionChainIdEnum number56 =
      _$fundingWalletActionChainIdEnum_number56;
  @BuiltValueEnumConst(wireNumber: 8453)
  static const FundingWalletActionChainIdEnum number8453 =
      _$fundingWalletActionChainIdEnum_number8453;
  @BuiltValueEnumConst(wireNumber: 42161)
  static const FundingWalletActionChainIdEnum number42161 =
      _$fundingWalletActionChainIdEnum_number42161;
  @BuiltValueEnumConst(wireNumber: 11184809, fallback: true)
  static const FundingWalletActionChainIdEnum unknownDefaultOpenApi =
      _$fundingWalletActionChainIdEnum_unknownDefaultOpenApi;

  static Serializer<FundingWalletActionChainIdEnum> get serializer =>
      _$fundingWalletActionChainIdEnumSerializer;

  const FundingWalletActionChainIdEnum._(String name) : super(name);

  static BuiltSet<FundingWalletActionChainIdEnum> get values =>
      _$fundingWalletActionChainIdEnumValues;
  static FundingWalletActionChainIdEnum valueOf(String name) =>
      _$fundingWalletActionChainIdEnumValueOf(name);
}
...
class FundingWalletActionValueEnum extends EnumClass {
  ...
  static const FundingWalletActionValueEnum n0x0 =
      _$fundingWalletActionValueEnum_n0x0;

  /// Native-value transfer is forbidden; v1 only executes zero-value contract calls.
  @BuiltValueEnumConst(wireName: r'unknown_default_open_api', fallback: true)
  static const FundingWalletActionValueEnum unknownDefaultOpenApi =
      _$fundingWalletActionValueEnum_unknownDefaultOpenApi;

  static Serializer<FundingWalletActionValueEnum> get serializer =>
      _$fundingWalletActionValueEnumSerializer;

  const FundingWalletActionValueEnum._(String name) : super(name);

  static BuiltSet<FundingWalletActionValueEnum> get values =>
      _$fundingWalletActionValueEnumValues;
  static FundingWalletActionValueEnum valueOf(String name) =>
      _$fundingWalletActionValueEnumValueOf(name);
}
