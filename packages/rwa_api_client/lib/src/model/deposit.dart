...
class _$DepositSerializer implements PrimitiveSerializer<Deposit> {
  ...
  Deposit deserialize(
    ...
    final discIndex = serializedList.indexOf(Deposit.discriminatorFieldName) + 1;
    final discValue = serializers.deserialize(serializedList[discIndex], specifiedType: FullType(String)) as String;
    oneOfDataSrc = serialized;
    final oneOfTypes = [ArbitrumConfirmedDeposit, BscConfirmedDeposit, ];
    Object oneOfResult;
    Type oneOfType;
    switch (discValue) {
      case r'Arbitrum':
...
class DepositChainIdEnum extends EnumClass {
  ...
  static DepositChainIdEnum valueOf(String name) => _$depositChainIdEnumValueOf(name);
}
...
class DepositTokenContractEnum extends EnumClass {
  ...
  static BuiltSet<DepositTokenContractEnum> get values => _$depositTokenContractEnumValues;
  static DepositTokenContractEnum valueOf(String name) => _$depositTokenContractEnumValueOf(name);
}
...
class DepositTokenDecimalsEnum extends EnumClass {
  ...
  static BuiltSet<DepositTokenDecimalsEnum> get values => _$depositTokenDecimalsEnumValues;
  static DepositTokenDecimalsEnum valueOf(String name) => _$depositTokenDecimalsEnumValueOf(name);
}
