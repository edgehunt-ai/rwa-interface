...
@BuiltValue()
abstract class UserPaidWalletActionExecutionSubmissionRequest
    implements
        Built<UserPaidWalletActionExecutionSubmissionRequest,
  ...
  factory UserPaidWalletActionExecutionSubmissionRequest(
          [void updates(
              UserPaidWalletActionExecutionSubmissionRequestBuilder b)]) =
      _$UserPaidWalletActionExecutionSubmissionRequest;
  ...
  static Serializer<UserPaidWalletActionExecutionSubmissionRequest>
      get serializer =>
          _$UserPaidWalletActionExecutionSubmissionRequestSerializer();
}

class _$UserPaidWalletActionExecutionSubmissionRequestSerializer
    implements
        PrimitiveSerializer<UserPaidWalletActionExecutionSubmissionRequest> {
  @override
