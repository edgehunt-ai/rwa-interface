...
/// * [verifyingContract]
@BuiltValue()
abstract class Hip3Eip712Domain
    implements Built<Hip3Eip712Domain, Hip3Eip712DomainBuilder> {
  ...
  factory Hip3Eip712Domain([void updates(Hip3Eip712DomainBuilder b)]) =
      _$Hip3Eip712Domain;
  ...
  static Serializer<Hip3Eip712Domain> get serializer =>
      _$Hip3Eip712DomainSerializer();
}

class _$Hip3Eip712DomainSerializer
    implements PrimitiveSerializer<Hip3Eip712Domain> {
  @override
      ...
      switch (key) {
        ...
        case r'verifyingContract':
          final valueDes = serializers.deserialize(
            value,
            specifiedType:
                const FullType(Hip3Eip712DomainVerifyingContractEnum),
...
class Hip3Eip712DomainNameEnum extends EnumClass {
  ...
  static const Hip3Eip712DomainNameEnum exchange =
      _$hip3Eip712DomainNameEnum_exchange;
  @BuiltValueEnumConst(wireName: r'unknown_default_open_api', fallback: true)
  static const Hip3Eip712DomainNameEnum unknownDefaultOpenApi =
      _$hip3Eip712DomainNameEnum_unknownDefaultOpenApi;

  static Serializer<Hip3Eip712DomainNameEnum> get serializer =>
      _$hip3Eip712DomainNameEnumSerializer;

  const Hip3Eip712DomainNameEnum._(String name) : super(name);

  static BuiltSet<Hip3Eip712DomainNameEnum> get values =>
      _$hip3Eip712DomainNameEnumValues;
  static Hip3Eip712DomainNameEnum valueOf(String name) =>
      _$hip3Eip712DomainNameEnumValueOf(name);
}

class Hip3Eip712DomainVersionEnum extends EnumClass {
  @BuiltValueEnumConst(wireName: r'1')
  static const Hip3Eip712DomainVersionEnum n1 =
      _$hip3Eip712DomainVersionEnum_n1;
  @BuiltValueEnumConst(wireName: r'unknown_default_open_api', fallback: true)
  static const Hip3Eip712DomainVersionEnum unknownDefaultOpenApi =
      _$hip3Eip712DomainVersionEnum_unknownDefaultOpenApi;

  static Serializer<Hip3Eip712DomainVersionEnum> get serializer =>
      _$hip3Eip712DomainVersionEnumSerializer;

  const Hip3Eip712DomainVersionEnum._(String name) : super(name);

  static BuiltSet<Hip3Eip712DomainVersionEnum> get values =>
      _$hip3Eip712DomainVersionEnumValues;
  static Hip3Eip712DomainVersionEnum valueOf(String name) =>
      _$hip3Eip712DomainVersionEnumValueOf(name);
}

class Hip3Eip712DomainChainIdEnum extends EnumClass {
  @BuiltValueEnumConst(wireNumber: 1337)
  static const Hip3Eip712DomainChainIdEnum number1337 =
      _$hip3Eip712DomainChainIdEnum_number1337;
  @BuiltValueEnumConst(wireNumber: 11184809, fallback: true)
  static const Hip3Eip712DomainChainIdEnum unknownDefaultOpenApi =
      _$hip3Eip712DomainChainIdEnum_unknownDefaultOpenApi;

  static Serializer<Hip3Eip712DomainChainIdEnum> get serializer =>
      _$hip3Eip712DomainChainIdEnumSerializer;

  const Hip3Eip712DomainChainIdEnum._(String name) : super(name);

  static BuiltSet<Hip3Eip712DomainChainIdEnum> get values =>
      _$hip3Eip712DomainChainIdEnumValues;
  static Hip3Eip712DomainChainIdEnum valueOf(String name) =>
      _$hip3Eip712DomainChainIdEnumValueOf(name);
}
...
class Hip3Eip712DomainVerifyingContractEnum extends EnumClass {
  ...
  static const Hip3Eip712DomainVerifyingContractEnum
  ...
  @BuiltValueEnumConst(wireName: r'unknown_default_open_api', fallback: true)
  static const Hip3Eip712DomainVerifyingContractEnum unknownDefaultOpenApi =
      _$hip3Eip712DomainVerifyingContractEnum_unknownDefaultOpenApi;

  static Serializer<Hip3Eip712DomainVerifyingContractEnum> get serializer =>
      _$hip3Eip712DomainVerifyingContractEnumSerializer;

  const Hip3Eip712DomainVerifyingContractEnum._(String name) : super(name);

  static BuiltSet<Hip3Eip712DomainVerifyingContractEnum> get values =>
      _$hip3Eip712DomainVerifyingContractEnumValues;
  static Hip3Eip712DomainVerifyingContractEnum valueOf(String name) =>
      _$hip3Eip712DomainVerifyingContractEnumValueOf(name);
}
