...
/// * [availability] 
@BuiltValue()
abstract class BscDepositRail implements DepositRailBase, Built<BscDepositRail, BscDepositRailBuilder> {
  BscDepositRail._();

  factory BscDepositRail([void updates(BscDepositRailBuilder b)]) = _$BscDepositRail;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(BscDepositRailBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<BscDepositRail> get serializer => _$BscDepositRailSerializer();
}

class _$BscDepositRailSerializer implements PrimitiveSerializer<BscDepositRail> {
  @override
...
class BscDepositRailChainEnum extends EnumClass {
  ...
  static BuiltSet<BscDepositRailChainEnum> get values => _$bscDepositRailChainEnumValues;
  static BscDepositRailChainEnum valueOf(String name) => _$bscDepositRailChainEnumValueOf(name);
}
...
class BscDepositRailChainIdEnum extends EnumClass {
  ...
  static BuiltSet<BscDepositRailChainIdEnum> get values => _$bscDepositRailChainIdEnumValues;
  static BscDepositRailChainIdEnum valueOf(String name) => _$bscDepositRailChainIdEnumValueOf(name);
}
...
class BscDepositRailTokenEnum extends EnumClass {
  ...
  static BuiltSet<BscDepositRailTokenEnum> get values => _$bscDepositRailTokenEnumValues;
  static BscDepositRailTokenEnum valueOf(String name) => _$bscDepositRailTokenEnumValueOf(name);
}
...
class BscDepositRailTokenContractEnum extends EnumClass {
  ...
  static BuiltSet<BscDepositRailTokenContractEnum> get values => _$bscDepositRailTokenContractEnumValues;
  static BscDepositRailTokenContractEnum valueOf(String name) => _$bscDepositRailTokenContractEnumValueOf(name);
}
...
class BscDepositRailTokenDecimalsEnum extends EnumClass {
  ...
  static BuiltSet<BscDepositRailTokenDecimalsEnum> get values => _$bscDepositRailTokenDecimalsEnumValues;
  static BscDepositRailTokenDecimalsEnum valueOf(String name) => _$bscDepositRailTokenDecimalsEnumValueOf(name);
}
...
class BscDepositRailConfirmationsRequiredEnum extends EnumClass {
  ...
  static BuiltSet<BscDepositRailConfirmationsRequiredEnum> get values => _$bscDepositRailConfirmationsRequiredEnumValues;
  static BscDepositRailConfirmationsRequiredEnum valueOf(String name) => _$bscDepositRailConfirmationsRequiredEnumValueOf(name);
}
