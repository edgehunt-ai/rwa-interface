...
/// * [warning] 
@BuiltValue()
abstract class ArbitrumDepositAddress implements DepositAddressBase, Built<ArbitrumDepositAddress, ArbitrumDepositAddressBuilder> {
  ArbitrumDepositAddress._();

  factory ArbitrumDepositAddress([void updates(ArbitrumDepositAddressBuilder b)]) = _$ArbitrumDepositAddress;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(ArbitrumDepositAddressBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<ArbitrumDepositAddress> get serializer => _$ArbitrumDepositAddressSerializer();
}

class _$ArbitrumDepositAddressSerializer implements PrimitiveSerializer<ArbitrumDepositAddress> {
  @override
  final Iterable<Type> types = const [ArbitrumDepositAddress, _$ArbitrumDepositAddress];
...
class ArbitrumDepositAddressChainEnum extends EnumClass {
  ...
  static BuiltSet<ArbitrumDepositAddressChainEnum> get values => _$arbitrumDepositAddressChainEnumValues;
  static ArbitrumDepositAddressChainEnum valueOf(String name) => _$arbitrumDepositAddressChainEnumValueOf(name);
}
...
class ArbitrumDepositAddressChainIdEnum extends EnumClass {
  ...
  static BuiltSet<ArbitrumDepositAddressChainIdEnum> get values => _$arbitrumDepositAddressChainIdEnumValues;
  static ArbitrumDepositAddressChainIdEnum valueOf(String name) => _$arbitrumDepositAddressChainIdEnumValueOf(name);
}
...
class ArbitrumDepositAddressTokenEnum extends EnumClass {
  ...
  static BuiltSet<ArbitrumDepositAddressTokenEnum> get values => _$arbitrumDepositAddressTokenEnumValues;
  static ArbitrumDepositAddressTokenEnum valueOf(String name) => _$arbitrumDepositAddressTokenEnumValueOf(name);
}
...
class ArbitrumDepositAddressTokenContractEnum extends EnumClass {
  ...
  static BuiltSet<ArbitrumDepositAddressTokenContractEnum> get values => _$arbitrumDepositAddressTokenContractEnumValues;
  static ArbitrumDepositAddressTokenContractEnum valueOf(String name) => _$arbitrumDepositAddressTokenContractEnumValueOf(name);
}
...
class ArbitrumDepositAddressTokenDecimalsEnum extends EnumClass {
  ...
  static BuiltSet<ArbitrumDepositAddressTokenDecimalsEnum> get values => _$arbitrumDepositAddressTokenDecimalsEnumValues;
  static ArbitrumDepositAddressTokenDecimalsEnum valueOf(String name) => _$arbitrumDepositAddressTokenDecimalsEnumValueOf(name);
}
...
class ArbitrumDepositAddressConfirmationsRequiredEnum extends EnumClass {
  ...
  const ArbitrumDepositAddressConfirmationsRequiredEnum._(String name): super(name);

  static BuiltSet<ArbitrumDepositAddressConfirmationsRequiredEnum> get values => _$arbitrumDepositAddressConfirmationsRequiredEnumValues;
  static ArbitrumDepositAddressConfirmationsRequiredEnum valueOf(String name) => _$arbitrumDepositAddressConfirmationsRequiredEnumValueOf(name);
}
