...
class _$FundingRailSerializer implements PrimitiveSerializer<FundingRail> {
  ...
  FundingRail deserialize(
    ...
    final discIndex =
        serializedList.indexOf(FundingRail.discriminatorFieldName) + 1;
...
class FundingRailRailEnum extends EnumClass {
  ...
  static const FundingRailRailEnum unknownDefaultOpenApi =
      _$fundingRailRailEnum_unknownDefaultOpenApi;

  static Serializer<FundingRailRailEnum> get serializer =>
      _$fundingRailRailEnumSerializer;

  const FundingRailRailEnum._(String name) : super(name);

  static BuiltSet<FundingRailRailEnum> get values =>
      _$fundingRailRailEnumValues;
  static FundingRailRailEnum valueOf(String name) =>
      _$fundingRailRailEnumValueOf(name);
}

class FundingRailNetworkEnum extends EnumClass {
  @BuiltValueEnumConst(wireName: r'Arbitrum')
  static const FundingRailNetworkEnum arbitrum =
      _$fundingRailNetworkEnum_arbitrum;
  @BuiltValueEnumConst(wireName: r'unknown_default_open_api', fallback: true)
  static const FundingRailNetworkEnum unknownDefaultOpenApi =
      _$fundingRailNetworkEnum_unknownDefaultOpenApi;

  static Serializer<FundingRailNetworkEnum> get serializer =>
      _$fundingRailNetworkEnumSerializer;

  const FundingRailNetworkEnum._(String name) : super(name);

  static BuiltSet<FundingRailNetworkEnum> get values =>
      _$fundingRailNetworkEnumValues;
  static FundingRailNetworkEnum valueOf(String name) =>
      _$fundingRailNetworkEnumValueOf(name);
}

class FundingRailSettlementAssetEnum extends EnumClass {
  @BuiltValueEnumConst(wireName: r'USDC')
  static const FundingRailSettlementAssetEnum USDC =
      _$fundingRailSettlementAssetEnum_USDC;
  @BuiltValueEnumConst(wireName: r'unknown_default_open_api', fallback: true)
  static const FundingRailSettlementAssetEnum unknownDefaultOpenApi =
      _$fundingRailSettlementAssetEnum_unknownDefaultOpenApi;

  static Serializer<FundingRailSettlementAssetEnum> get serializer =>
      _$fundingRailSettlementAssetEnumSerializer;

  const FundingRailSettlementAssetEnum._(String name) : super(name);

  static BuiltSet<FundingRailSettlementAssetEnum> get values =>
      _$fundingRailSettlementAssetEnumValues;
  static FundingRailSettlementAssetEnum valueOf(String name) =>
      _$fundingRailSettlementAssetEnumValueOf(name);
}

class FundingRailChainIdEnum extends EnumClass {
  @BuiltValueEnumConst(wireNumber: 1337)
  static const FundingRailChainIdEnum number1337 =
      _$fundingRailChainIdEnum_number1337;
  @BuiltValueEnumConst(wireNumber: 11184809, fallback: true)
  static const FundingRailChainIdEnum unknownDefaultOpenApi =
      _$fundingRailChainIdEnum_unknownDefaultOpenApi;

  static Serializer<FundingRailChainIdEnum> get serializer =>
      _$fundingRailChainIdEnumSerializer;

  const FundingRailChainIdEnum._(String name) : super(name);

  static BuiltSet<FundingRailChainIdEnum> get values =>
      _$fundingRailChainIdEnumValues;
  static FundingRailChainIdEnum valueOf(String name) =>
      _$fundingRailChainIdEnumValueOf(name);
}

class FundingRailSettlementAssetIdEnum extends EnumClass {
  @BuiltValueEnumConst(wireName: r'hyperliquid:1337/perps:USDC-PERPS')
  static const FundingRailSettlementAssetIdEnum
  ...
  @BuiltValueEnumConst(wireName: r'unknown_default_open_api', fallback: true)
  static const FundingRailSettlementAssetIdEnum unknownDefaultOpenApi =
      _$fundingRailSettlementAssetIdEnum_unknownDefaultOpenApi;

  static Serializer<FundingRailSettlementAssetIdEnum> get serializer =>
      _$fundingRailSettlementAssetIdEnumSerializer;

  const FundingRailSettlementAssetIdEnum._(String name) : super(name);

  static BuiltSet<FundingRailSettlementAssetIdEnum> get values =>
      _$fundingRailSettlementAssetIdEnumValues;
  static FundingRailSettlementAssetIdEnum valueOf(String name) =>
      _$fundingRailSettlementAssetIdEnumValueOf(name);
}
...
class FundingRailTokenContractEnum extends EnumClass {
  ...
  static const FundingRailTokenContractEnum
      n0x2100000000000000000000000000000000000000 =
      _$fundingRailTokenContractEnum_n0x2100000000000000000000000000000000000000;
  @BuiltValueEnumConst(wireName: r'unknown_default_open_api', fallback: true)
  static const FundingRailTokenContractEnum unknownDefaultOpenApi =
      _$fundingRailTokenContractEnum_unknownDefaultOpenApi;

  static Serializer<FundingRailTokenContractEnum> get serializer =>
      _$fundingRailTokenContractEnumSerializer;

  const FundingRailTokenContractEnum._(String name) : super(name);

  static BuiltSet<FundingRailTokenContractEnum> get values =>
      _$fundingRailTokenContractEnumValues;
  static FundingRailTokenContractEnum valueOf(String name) =>
      _$fundingRailTokenContractEnumValueOf(name);
}

class FundingRailTokenDecimalsEnum extends EnumClass {
  @BuiltValueEnumConst(wireNumber: 8)
  static const FundingRailTokenDecimalsEnum number8 =
      _$fundingRailTokenDecimalsEnum_number8;
  @BuiltValueEnumConst(wireNumber: 11184809, fallback: true)
  static const FundingRailTokenDecimalsEnum unknownDefaultOpenApi =
      _$fundingRailTokenDecimalsEnum_unknownDefaultOpenApi;

  static Serializer<FundingRailTokenDecimalsEnum> get serializer =>
      _$fundingRailTokenDecimalsEnumSerializer;

  const FundingRailTokenDecimalsEnum._(String name) : super(name);

  static BuiltSet<FundingRailTokenDecimalsEnum> get values =>
      _$fundingRailTokenDecimalsEnumValues;
  static FundingRailTokenDecimalsEnum valueOf(String name) =>
      _$fundingRailTokenDecimalsEnumValueOf(name);
}
