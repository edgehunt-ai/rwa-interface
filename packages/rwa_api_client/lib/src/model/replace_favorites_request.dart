...
part 'replace_favorites_request.g.dart';
...
class _$ReplaceFavoritesRequestSerializer
  ...
  Iterable<Object?> _serializeProperties(
    ...
    yield serializers.serialize(
      object.items,
      specifiedType: const FullType(BuiltList, [FullType(ProductRef)]),
    );
  }
  ...
  void _deserializeProperties(
    ...
    required ReplaceFavoritesRequestBuilder result,
  ...
  @override
  ReplaceFavoritesRequest deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = ReplaceFavoritesRequestBuilder();
