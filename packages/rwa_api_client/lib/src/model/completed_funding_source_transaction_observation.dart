...
/// * [observedAt]
@BuiltValue()
abstract class CompletedFundingSourceTransactionObservation
    implements
        Built<CompletedFundingSourceTransactionObservation,
  ...
  factory CompletedFundingSourceTransactionObservation(
          [void updates(
              CompletedFundingSourceTransactionObservationBuilder b)]) =
      _$CompletedFundingSourceTransactionObservation;
  ...
  static Serializer<CompletedFundingSourceTransactionObservation>
      get serializer =>
          _$CompletedFundingSourceTransactionObservationSerializer();
}

class _$CompletedFundingSourceTransactionObservationSerializer
    implements
        PrimitiveSerializer<CompletedFundingSourceTransactionObservation> {
  @override
...
class CompletedFundingSourceTransactionObservationStatusEnum extends EnumClass {
  ...
  static const CompletedFundingSourceTransactionObservationStatusEnum
      confirmed =
  ...
  static Serializer<CompletedFundingSourceTransactionObservationStatusEnum>
      get serializer =>
          _$completedFundingSourceTransactionObservationStatusEnumSerializer;

  const CompletedFundingSourceTransactionObservationStatusEnum._(String name)
      : super(name);

  static BuiltSet<CompletedFundingSourceTransactionObservationStatusEnum>
      get values =>
          _$completedFundingSourceTransactionObservationStatusEnumValues;
  static CompletedFundingSourceTransactionObservationStatusEnum valueOf(
          String name) =>
      _$completedFundingSourceTransactionObservationStatusEnumValueOf(name);
}
