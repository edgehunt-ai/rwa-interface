...
class UserSettingsLanguageEnum extends EnumClass {
  ...
  static const UserSettingsLanguageEnum unknownDefaultOpenApi =
      _$userSettingsLanguageEnum_unknownDefaultOpenApi;

  static Serializer<UserSettingsLanguageEnum> get serializer =>
      _$userSettingsLanguageEnumSerializer;

  const UserSettingsLanguageEnum._(String name) : super(name);

  static BuiltSet<UserSettingsLanguageEnum> get values =>
      _$userSettingsLanguageEnumValues;
  static UserSettingsLanguageEnum valueOf(String name) =>
      _$userSettingsLanguageEnumValueOf(name);
}
