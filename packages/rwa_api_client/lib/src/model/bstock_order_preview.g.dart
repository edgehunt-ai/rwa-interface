...
const BstockOrderPreviewFundingModeEnum
    _$bstockOrderPreviewFundingModeEnum_unreservedTransferFrom =
    const BstockOrderPreviewFundingModeEnum._('unreservedTransferFrom');
const BstockOrderPreviewFundingModeEnum
    _$bstockOrderPreviewFundingModeEnum_unknownDefaultOpenApi =
    const BstockOrderPreviewFundingModeEnum._('unknownDefaultOpenApi');

BstockOrderPreviewFundingModeEnum _$bstockOrderPreviewFundingModeEnumValueOf(
    String name) {
  switch (name) {
    case 'unreservedTransferFrom':
      return _$bstockOrderPreviewFundingModeEnum_unreservedTransferFrom;
    case 'unknownDefaultOpenApi':
      return _$bstockOrderPreviewFundingModeEnum_unknownDefaultOpenApi;
    default:
      return _$bstockOrderPreviewFundingModeEnum_unknownDefaultOpenApi;
  }
}

final BuiltSet<BstockOrderPreviewFundingModeEnum>
    _$bstockOrderPreviewFundingModeEnumValues = BuiltSet<
        BstockOrderPreviewFundingModeEnum>(const <BstockOrderPreviewFundingModeEnum>[
  _$bstockOrderPreviewFundingModeEnum_unreservedTransferFrom,
  _$bstockOrderPreviewFundingModeEnum_unknownDefaultOpenApi,
]);
...
Serializer<BstockOrderPreviewFundingModeEnum>
    _$bstockOrderPreviewFundingModeEnumSerializer =
    _$BstockOrderPreviewFundingModeEnumSerializer();
...
class _$BstockOrderPreviewFundingModeEnumSerializer
    implements PrimitiveSerializer<BstockOrderPreviewFundingModeEnum> {
  ...
  @override
  final Iterable<Type> types = const <Type>[BstockOrderPreviewFundingModeEnum];
  @override
  final String wireName = 'BstockOrderPreviewFundingModeEnum';

  @override
  Object serialize(
          Serializers serializers, BstockOrderPreviewFundingModeEnum object,
          {FullType specifiedType = FullType.unspecified}) =>
      _toWire[object.name] ?? object.name;

  @override
  BstockOrderPreviewFundingModeEnum deserialize(
          Serializers serializers, Object serialized,
          {FullType specifiedType = FullType.unspecified}) =>
      BstockOrderPreviewFundingModeEnum.valueOf(
