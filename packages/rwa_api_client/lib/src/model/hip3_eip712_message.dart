...
/// * [connectionId]
@BuiltValue()
abstract class Hip3Eip712Message
    implements Built<Hip3Eip712Message, Hip3Eip712MessageBuilder> {
  ...
  factory Hip3Eip712Message([void updates(Hip3Eip712MessageBuilder b)]) =
      _$Hip3Eip712Message;
  ...
  static Serializer<Hip3Eip712Message> get serializer =>
      _$Hip3Eip712MessageSerializer();
}

class _$Hip3Eip712MessageSerializer
    implements PrimitiveSerializer<Hip3Eip712Message> {
  @override
...
class Hip3Eip712MessageSource_Enum extends EnumClass {
  ...
  static const Hip3Eip712MessageSource_Enum unknownDefaultOpenApi =
      _$hip3Eip712MessageSourceEnum_unknownDefaultOpenApi;

  static Serializer<Hip3Eip712MessageSource_Enum> get serializer =>
      _$hip3Eip712MessageSourceEnumSerializer;

  const Hip3Eip712MessageSource_Enum._(String name) : super(name);

  static BuiltSet<Hip3Eip712MessageSource_Enum> get values =>
      _$hip3Eip712MessageSourceEnumValues;
  static Hip3Eip712MessageSource_Enum valueOf(String name) =>
      _$hip3Eip712MessageSourceEnumValueOf(name);
}
