...
class Hip3OrderHistoryScreen extends ConsumerStatefulWidget {
  const Hip3OrderHistoryScreen({super.key});
  @override
  ConsumerState<Hip3OrderHistoryScreen> createState() => _HistoryState();
}

class _HistoryState extends ConsumerState<Hip3OrderHistoryScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return AppPageScaffold(
      title: l10n.hip3OrderHistoryTitle,
